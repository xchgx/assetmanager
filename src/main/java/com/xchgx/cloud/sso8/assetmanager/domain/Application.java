...
//    private long rukudanId; //入库单
    ...
    private Date beginDate =new Date(); //提交申请的时间,应该由系统自动生成
    private Date resultDate; //处理时间，该申请已经得到管理员的批示
//    private int amount;//申请资产的个数 2020年4月15日：删掉该参数，申请单只能申请一个资产
    ...
    private String status;//申请单的状态 同意、拒绝、待处理，维修成功，维修失败
